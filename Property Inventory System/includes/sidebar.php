...
<div class="sidebar">
    ...
    <nav class="nav flex-column gap-2">
        ...
        <a class="nav-link text-danger logout-link" href="logout.php" onclick="return confirmLogout(event)">
...
function confirmLogout(event) {
    ...
    const confirmAction = confirm("Are you sure you want to log out of AssetFlow?");
    
    if (!confirmAction) {
        // If the user clicks "Cancel", stop the link from following through to logout.php
        event.preventDefault();
        return false;
    }
    // If the user clicks "OK", the browser continues to logout.php
    return true;
}
</script>